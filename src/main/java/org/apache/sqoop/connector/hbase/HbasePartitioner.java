...
public class HbasePartitioner extends Partitioner<LinkConfiguration, FromJobConfiguration> {
  ...
  public List<Partition> getPartitions(PartitionerContext context, LinkConfiguration linkConfig,
    ...
    partitionColumnName = context.getString(HbaseConnectorConstants.CONNECTOR_JDBC_PARTITION_COLUMNNAME);
    partitionColumnType = context.getInt(HbaseConnectorConstants.CONNECTOR_JDBC_PARTITION_COLUMNTYPE, -1);
    partitionMinValue = context.getString(HbaseConnectorConstants.CONNECTOR_JDBC_PARTITION_MINVALUE);
    partitionMaxValue = context.getString(HbaseConnectorConstants.CONNECTOR_JDBC_PARTITION_MAXVALUE);
