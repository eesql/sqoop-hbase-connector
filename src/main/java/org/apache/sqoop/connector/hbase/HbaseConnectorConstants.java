 ...
 *
 */
public final class HbaseConnectorConstants {

  // Resource bundle name
  public static final String RESOURCE_BUNDLE_NAME =
      "hbase-connector-config";

  // Add version info temporary
  public static String getVersion() {
    return "Sqoop-hbase-connector v0.1 alpha";
  }
  ...
  private HbaseConnectorConstants() {
