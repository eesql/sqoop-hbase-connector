...
public class TestFromInitializer {
  ...
  public void testTableName() throws Exception {
    ...
    Initializer initializer = new HbaseFromInitializer();
  ...
  public void testIncrementalTableNameFullRange() throws Exception {
    ...
    assertEquals(String.valueOf(START+NUMBER_OF_ROWS-1), context.getString(HbaseConnectorConstants.CONNECTOR_JDBC_LAST_INCREMENTAL_VALUE));
  }
