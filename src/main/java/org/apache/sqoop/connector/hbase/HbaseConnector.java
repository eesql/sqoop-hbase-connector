...
public class HbaseConnector extends SqoopConnector {
  ...
  private static final From FROM = new From(
      HbaseFromInitializer.class,
      HbasePartitioner.class,
      HbaseExtractor.class,
      HbaseFromDestroyer.class);
  ...
  public String getVersion() {
    return HbaseConnectorConstants.getVersion();
  }

  @Override
  public ResourceBundle getBundle(Locale locale) {
    return ResourceBundle.getBundle(
      HbaseConnectorConstants.RESOURCE_BUNDLE_NAME, locale);
  }
