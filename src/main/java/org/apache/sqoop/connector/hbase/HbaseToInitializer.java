...
import org.apache.sqoop.connector.hbase.configuration.ToJobConfiguration;
...
public class HbaseToInitializer extends Initializer<LinkConfiguration, ToJobConfiguration> {

  private HbaseExecutor executor;
  private static final Logger LOG =
    Logger.getLogger(HbaseToInitializer.class);
  ...
  private void configureTableProperties(MutableContext context, LinkConfiguration linkConfig, ToJobConfiguration toJobConfig) {
    ...
    if (tableName != null && tableSql != null) {
      ...
      if (tableSql.indexOf(
          HbaseConnectorConstants.SQL_PARAMETER_MARKER) == -1) {
    ...
    context.setString(HbaseConnectorConstants.CONNECTOR_JDBC_TO_DATA_SQL,
        dataSql);
  }
}
