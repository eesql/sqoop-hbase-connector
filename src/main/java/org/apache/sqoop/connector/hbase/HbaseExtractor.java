...
public class HbaseExtractor extends Extractor<LinkConfiguration, FromJobConfiguration, GenericJdbcPartition> {

 public static final Logger LOG = Logger.getLogger(HbaseExtractor.class);
