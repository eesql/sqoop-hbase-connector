...
import org.apache.sqoop.connector.hbase.HbaseConnectorConstants;
...
public class FromJobConfig {
  ...
  @Input(size = 2000, validators = { @Validator(value = NullOrContains.class, strArg = HbaseConnectorConstants.SQL_CONDITIONS_TOKEN) })
  public String sql;
